...
Takes the Cover on `cover` and, optionally, the wrap on `wrap`. Three views:
standing (spine showing — from the wrap if wired, a flat colour if not),
flat, and the wrap laid open. Output is 2400 × 1800.
